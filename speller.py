...
def speller_text():
    ...
    Класс YandexSpeller предлагает проверку строки.
    Метод spelled получает на вход строку и возвращает отредактированную строку.
...
def speller_word():
    ...
    Класс word предлагает проверку по одному слову.
